...
template <typename T> class RepositoryMock : public IRepository<T> {
public:
    ...
    MOCK_METHOD(std::vector<T>, getByField,
                (const std::string &fieldName, const std::string &value), (const, override));
