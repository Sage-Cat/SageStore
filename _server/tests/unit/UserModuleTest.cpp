...
TEST_F(UserModuleTest, addRoles)
{
    ...
    RequestData requestData{
        ...
        .method     = "POST",
        .resourceId = "",
        .dataset    = {{Keys::Role::ID, {CORRECT_ID}}, {Keys::Role::NAME, {CORRECT_NAME}}}};
    ...
    EXPECT_EQ(response.dataset.at(Keys::Role::NAME).front(),
              requestData.dataset.at(Keys::Role::NAME).front());
}
...
TEST_F(UserModuleTest, editRole)
{
    ...
    RequestData requestData{
        ...
        .method     = "PUT",
        .resourceId = "3",
        .dataset    = {{Keys::Role::ID, {CORRECT_ID}}, {Keys::Role::NAME, {"admin12"}}}};
