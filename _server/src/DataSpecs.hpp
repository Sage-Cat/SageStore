 ...
 */
struct RequestData {
    std::string module;     ///< Main module, that will proceed request, like 'users'
                            ///< or 'sales'.
    std::string submodule;  ///< Module spesific process, like 'login' for users,
                            ///< 'records' for sales.
...
/**
 * @struct ResponseData
 * @brief Structure to hold information about an response, that will be sent to
 * client.
 */
struct ResponseData {
    Dataset dataset;
